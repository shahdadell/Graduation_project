...
class ApiManager {
  ...
  Future<Either<Faliures, RegisterResponseDTO>> register(
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      if(response.statusCode >= 200 && response.statusCode < 300){
        ...
        return Left(Faliures(errorMessage: registerResponse.status != null ?
  ...
  Future<Either<Faliures, LoginResponseDTO>> login(
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      if(response.statusCode >= 200 && response.statusCode < 300){
        ...
        // احتكال الفانكشين دي تبقي غلط
        return Left(Faliures(errorMessage: loginResponse.status != null ?
  ...
  static Future<HomeCategories> getSources() async {
    Uri url = Uri.https(
    ...
    try {
      ...
      return HomeCategories.fromJson(json);
    } catch (e) {
      throw e;
    }
  }
